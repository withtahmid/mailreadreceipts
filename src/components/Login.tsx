...
const Login = () => {
    ...
    const loginBtn = async () => {
        setLoading(true);
        try {
            var resultAction = await dispatch(login({email, password}))
        ...
        <div className="hero bg-base-200 min-h-screen">
            <div className="hero-content flex-col lg:flex-row-reverse">
                ...
                <div className="card-body">
                    <h1 className="text-3xl font-bold text-nowrap">Login</h1>
                    ...
                    <label className="label">
                        <p  className="label-text-alt link link-hover" onClick={() => dispatch(changePage("signup"))}>Don't have an account? Signup.</p>
                    </label>
